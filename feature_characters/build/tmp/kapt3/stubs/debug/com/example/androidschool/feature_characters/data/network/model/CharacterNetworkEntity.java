...
public final class CharacterNetworkEntity {
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.example.androidschool.feature_characters.data.network.model.CharacterNetworkEntity copy(@org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "appearance")
    java.util.List<java.lang.Integer> appearance, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "better_call_saul_appearance")
    java.util.List<java.lang.Integer> betterCallSaulAppearance, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "birthday")
    java.lang.String birthday, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "category")
    java.lang.String category, @com.squareup.moshi.Json(name = "char_id")
    int charId, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "img")
    java.lang.String img, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "name")
    java.lang.String name, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "nickname")
    java.lang.String nickname, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "occupation")
    java.util.List<java.lang.String> occupation, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "portrayed")
    ...
    public CharacterNetworkEntity(@org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "appearance")
    java.util.List<java.lang.Integer> appearance, @org.jetbrains.annotations.NotNull()
    @com.squareup.moshi.Json(name = "better_call_saul_appearance")
    java.util.List<java.lang.Integer> betterCallSaulAppearance, @org.jetbrains.annotations.NotNull()
